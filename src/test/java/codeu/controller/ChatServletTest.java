  ...
  public void testDoGet() throws IOException, ServletException {
  	...
  	fakeMessageList.add(
  			new Message(UUID.randomUUID(), fakeConversationId, UUID.randomUUID(), "test message", Instant.now()));
  ...
  public void testDoPost_ProtoTags() throws IOException, ServletException{
